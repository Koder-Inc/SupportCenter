...
public struct SupportCenter {
    ...
    public static func present(from controller: UIViewController, reportOptions: [ReportOption]? = nil, email: String? = nil) {
        ...
        controller.present(SupportCenterViewController(options: reportOptions ?? DefaultReportOption.allCases, email: email), animated: false, completion: nil)
    }
